...
POST_PCVE = api.model('PCVE', {
    ...
    'title': fields.Url(description='title'),
    'body': fields.Url(description='body'),
...
GET_PCVE = api.model('GET_PCVE', {
    ...
    'title': UnsanitizeStringFormat(attribute=lambda x: None if 'title' not in x else x['title'][0],
